...
This repository tracks my progression for the Manning Publications book, _Tiny Python Projects_, by Ken Youens-Clark:
...
A short README is included to describe each exercise.
...
The author advocates a "test-driven development" mentality where we write tests _before_ we write code.
...
Videos for each chapter are on the author's YouTube channel:
